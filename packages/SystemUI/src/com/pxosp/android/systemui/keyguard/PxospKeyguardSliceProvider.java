package com.pxosp.android.systemui.keyguard;
...
public class PxospKeyguardSliceProvider extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    public Slice onBindSlice(Uri uri) {
        ...
        Trace.beginSection("PxospKeyguardSliceProvider#onBindSlice");
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<PxospKeyguardSliceProvider> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(PxospKeyguardSliceProvider pxospKeyguardSliceProvider, SmartSpaceCard smartSpaceCard) {
            this.mProviderReference = new WeakReference<>(pxospKeyguardSliceProvider);
            this.mWeatherCard = smartSpaceCard;
            this.mBlurRadius = pxospKeyguardSliceProvider.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            PxospKeyguardSliceProvider pxospKeyguardSliceProvider;
            synchronized (this) {
                this.mWeatherCard.setIcon(bitmap);
                pxospKeyguardSliceProvider = this.mProviderReference.get();
            }
            if (pxospKeyguardSliceProvider != null) {
                pxospKeyguardSliceProvider.notifyChange();
            }
        }
